...
module.exports = (inputs, outputs, { fee, feerate }) => {
  ...
  if (isALL) {
    if (fee) tx.subtractFee(fee)
    else if (feerate) { // sign a cloned copy of the tx to figure out its size and fee, then discard it
